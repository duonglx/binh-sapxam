...
import com.duonglx.binhsxapp.domain.Job;
import com.duonglx.binhsxapp.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.duonglx.binhsxapp.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
