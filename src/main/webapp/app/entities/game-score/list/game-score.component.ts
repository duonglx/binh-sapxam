...
export class GameScoreComponent implements OnInit {
  ...
  delete(gameScore: IGameScore): void {
    const modalRef = this.modalService.open(GameScoreDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.gameScore = gameScore;
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.gameScoreService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
